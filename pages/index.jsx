    ...
    <main>
            ...
            <div>
              ...
              <div style={{ display:"flex",alignItems:"center",gap:20,flexWrap:"wrap" }}>
                ...
                <div style={{ display:"flex",gap:20 }}>
                  ...
                  <a onClick={()=>router.push("/jobs-list")} style={{ fontWeight:600,color:"#2563eb",cursor:"pointer",display:"flex",alignItems:"center",gap:8,textDecoration:"none" }}>
      ...
      <div style={{ paddingTop:60,paddingBottom:20 }}>
        <div style={{ maxWidth:1280,margin:"0 auto",padding:"0 24px" }}>
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:20 }}>
            <a onClick={()=>router.push("/jobs-list")} style={{ background:"#0357e9",padding:"30px 110px 30px 40px",display:"block",borderRadius:100,color:"#fff",position:"relative",textDecoration:"none",cursor:"pointer" }}>
      ...
      <section style={{ padding:"80px 0" }}>
        <div style={{ maxWidth:1280,margin:"0 auto",padding:"0 24px" }}>
            ...
            {featuredJobs.map((job, i) => (
              <div key={i} style={{ background:"#fff",borderRadius:16,padding:20,border:"1px solid #e5e7eb",boxShadow:"0 4px 12px rgba(0,0,0,.05)" }}>
                ...
                <h4 style={{ fontSize:16,fontWeight:700,color:"#0f172a",marginBottom:8 }}>
                  <a onClick={()=>router.push("/jobs/job-single")} style={{ color:"inherit",cursor:"pointer",textDecoration:"none" }}>{job.title}</a>
                </h4>
          ...
          <div style={{ textAlign:"center",marginTop:40 }}>
            <button onClick={()=>router.push("/jobs-list")} style={{ padding:"14px 32px",borderRadius:999,background:"#2563eb",color:"#fff",border:"none",fontWeight:600,cursor:"pointer",fontSize:15 }}>View All Featured Jobs</button>
          </div>
        </div>
      </section>
            ...
            {latestJobs.map((job, i) => (
              <div key={i} style={{ background:"#fff",padding:20,borderRadius:12,border:"1px solid #e5e7eb",transition:"all 0.3s" }}
                ...
                <h4 style={{ fontSize:16,fontWeight:700,marginBottom:8 }}>
                  <a onClick={()=>router.push("/jobs/job-single")} style={{ color:"#1f2937",cursor:"pointer",textDecoration:"none" }}>{job.title}</a>
                </h4>
                ...
                <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",paddingTop:14,borderTop:"1px solid #e5e7eb" }}>
                  ...
                  <button onClick={()=>router.push("/jobs/job-single")} style={{ padding:"7px 14px",borderRadius:20,border:"1px solid #17d27c",color:"#17d27c",background:"transparent",cursor:"pointer",fontSize:12,fontWeight:600 }}>Apply Now</button>
                </div>
              </div>
            ))}
          </div>
